...
var handbooklinkInput = document.getElementById('handbook_link');

function newHandbook(link) {
    var linkValue = {
        link: link,
...
handbookForm.onsubmit = function(e) {
    e.preventDefault();
    var link_val = handbooklinkInput.value;

    newHandbook(link_val);
    handbooklinkInput.value = '';
